          ...
          <div class="ml-auto flex items-center">
            ...
            <div class="hidden lg:ml-8 lg:flex">
              <a href="#" class="flex items-center text-gray-700 hover:text-gray-800">
                <img src="https://europa.eu/webtools/images/flag.svg?t=1692798448" alt="" class="block h-auto w-5 flex-shrink-0" />
...
import { navigation } from '~/assets/data/categories.js';
